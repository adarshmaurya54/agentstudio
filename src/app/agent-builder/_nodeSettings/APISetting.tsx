...
function ApiSettings({ selectedNode, updateNodeSettingData }: any) {
    ...
    return (
        <div>
            ...
            <Button 
            disabled={(JSON.stringify(selectedNode?.data?.settings) === JSON.stringify(formData))}
            className='w-full mt-5' onClick={onSave}>Save</Button>
        </div>
    )
}
