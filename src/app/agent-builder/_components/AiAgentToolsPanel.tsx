...
function AiAgentToolsPanel() {
  ...
  return (
    <div className='bg-white/20 dark:bg-black/20 backdrop-blur-sm p-3 rounded-3xl border'>
        ...
        <div className="space-y-1">
          {AgentTools.map((tools) => (
            <div
              ...
              className="flex items-center gap-3 cursor-pointer rounded-xl p-2 transition-all duration-200 hover:bg-gray-200 dark:hover:bg-white/10 hover:scale-[1.02]"
            >
              <tools.icon
                className="p-2 h-8 w-8 rounded-lg text-black dark:text-white"
